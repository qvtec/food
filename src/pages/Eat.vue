<template>
  <div class="q-pa-md">
    ...
    <EatSearch :loading="this.loading" @search="search()" />

    <EatList :items="this.items" :loading="this.loading" @openEdit="openEdit" />

    <q-dialog v-model="addDialog">
      <EatAdd :loading="this.loading" @edit="edit" />
    </q-dialog>
...
<script>
import EatList from '../components/Eat/List'
import EatAdd from '../components/Eat/Add'
import EatSearch from '../components/Eat/Search'
